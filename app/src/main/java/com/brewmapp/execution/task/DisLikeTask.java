...
public class DisLikeTask extends BaseNetworkTask<LikeDislikePackage, MessageResponse> {

    private UserRepo userRepo;

    @Inject
    public DisLikeTask(MainThread mainThread,
                       Executor executor,
