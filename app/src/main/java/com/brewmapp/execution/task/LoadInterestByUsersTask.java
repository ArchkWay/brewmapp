...
public class LoadInterestByUsersTask extends BaseNetworkTask<LoadInterestPackage,List<IFlexible>> {
    ...
    protected Observable<List<IFlexible>> prepareObservable(LoadInterestPackage loadInterestPackage) {
        return Observable.create(subscriber -> {
          try {
              ...
              InterestsByUser interests=executeCall(getApi().loadInterestByUsers(start , end, params));
