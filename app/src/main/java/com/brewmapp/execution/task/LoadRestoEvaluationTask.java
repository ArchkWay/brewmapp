...
public class LoadRestoEvaluationTask extends BaseNetworkTask<RestoEvaluationPackage, String> {
    ...
    protected Observable<String> prepareObservable(RestoEvaluationPackage restoEvaluationPackage) {
        return Observable.create(subscriber -> {
            try {
                ...
                ListResponse<Evaluation> o= executeCall(getApi().getRestoEvaluation(params));
                subscriber.onNext("");
