...
public class SearchBeerTask extends BaseNetworkTask<FilterBeerPackage, List<IFlexible>> {
    ...
    @Override
    protected Observable<List<IFlexible>> prepareObservable(FilterBeerPackage beerPackage) {
