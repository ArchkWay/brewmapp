...
public class MainPresenterImpl extends BasePresenter<MainView> implements MainPresenter {
    ...
    public String parseMode(Intent intent) {
        if(MainActivity.MODE_EVENT_FRAGMENT_WITHOUT_TABS.equals(intent.getAction()))
            return MainActivity.MODE_EVENT_FRAGMENT_WITHOUT_TABS;
        else if(MainActivity.MODE_MAP_FRAGMENT.equals(intent.getAction()))
            return MainActivity.MODE_MAP_FRAGMENT;
        else if(MainActivity.MODE_SEARCH_FRAGMENT.equals(intent.getAction()))
            return MainActivity.MODE_SEARCH_FRAGMENT;
        else
