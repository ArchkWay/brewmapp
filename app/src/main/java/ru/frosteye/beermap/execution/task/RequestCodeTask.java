...
public class RequestCodeTask extends BaseNetworkTask<RequestParams, ResponseBody> {
    ...
    @Override
    protected Observable<ResponseBody> prepareObservable(RequestParams params) {
        return Observable.create(subscriber -> {
            try {
                ResponseBody response = executeCall(getApi().requestCode(params));
